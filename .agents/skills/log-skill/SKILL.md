...
- Membaca dan menambahkan log aktivitas yang baru saja dikerjakan ke dalam file `progress.txt`.
...
1. Cek apakah file `progress.txt` ada. Jika tidak ada, buat file tersebut.
2. Read `progress.txt` untuk melihat log terakhir.
...
### Kategori task
- Modified 'components/navbar.blade.php' - tambah font size text lg
