      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 reveal">
        <div className="reveal stagger-1 active">
          ...
          <p className="text-secondary mb-8">
            Punya ide proyek atau butuh bantuan dengan website Anda? Jangan
          ...
          <form action="#" className="space-y-4" method="POST">
            <div>
              <label
                className="block font-label-mono text-sm text-secondary mb-2"
                htmlFor="name"
              >
                Nama Lengkap
              </label>
            ...
            <button
              className="w-full py-4 bg-white text-black font-button text-button rounded-lg hover:bg-white/90 transition-colors"
              type="submit"
            >
              Kirim Pesan
            </button>
        ...
        <div className="space-y-6 reveal stagger-2 active">
          ...
          <div className="flex gap-4">
            <a
              className="card-bento flex-1 p-6 flex flex-col items-center justify-center gap-3 group"
              href="#"
            >
              <span className="material-symbols-outlined text-3xl text-secondary group-hover:text-white">
                code
              </span>
              <span className="font-label-mono text-sm text-secondary group-hover:text-white">
                GitHub
              </span>
            </a>
            <a
