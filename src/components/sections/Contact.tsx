      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 reveal">
        ...
        <div className="space-y-6 reveal">
          ...
          <div className="flex gap-4">
            <a className="card-bento flex-1 p-6 flex flex-col items-center justify-center gap-3 group card-hover card-hover-103" target="_blank" rel="noreferrer" href="https://github.com/AdjiBhawantu">
            ...
            <a className="card-bento flex-1 p-6 flex flex-col items-center justify-center gap-3 group card-hover card-hover-103" target="_blank" rel="noreferrer" href="https://instagram.com/pandxy.ocs">
