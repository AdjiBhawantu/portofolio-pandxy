  ...
  return (
    <section ref={sectionRef} className="px-gutter py-section-padding-y max-w-container-max mx-auto" id="about">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 reveal">
          <div className="md:col-span-7 card-bento p-8 md:p-12 flex flex-col justify-center card-hover-102">
        ...
        <div className="md:col-span-5 grid grid-rows-3 gap-4">
          {stats.map((stat) => (
            <div key={stat.label} className={`card-bento p-6 flex items-center gap-6 reveal ${stat.stagger} active card-hover-103`}>
